...
public class Condicionales7_DEOR {
	...
	public static void main(String[] args) {
		 ...
		 * alumnos, el costo es de 95 euros. * Menos de 30 alumnos, el costo de la renta del autobús 
		 * es de 4000 euros, sin importar el número de alumnos. Realiza un algoritmo que permita 
