...
public class Condicionales7_IGV {
	...
	public static void main(String[] args) {
		...
		*/
		...
		if (alumnos >= 100) {
			System.out.println("El costo por alumno seria: 65 Euros y lo que debe pagar a la compañia es:" + alumnos*65);
		
		} else if (alumnos >= 50 && alumnos <= 99) {
			System.out.println("El costo por alumno seria: 70 Euros y lo que debe pagar a la compañia es:" + alumnos*70);
		
		} else if (alumnos >= 30 && alumnos <= 49) {
			System.out.println("El costo por alumno seria: 70 Euros y lo que debe pagar a la compañia es:" + alumnos*95);
