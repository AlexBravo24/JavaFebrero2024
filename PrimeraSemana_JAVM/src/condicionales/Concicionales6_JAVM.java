...
public class Concicionales6_JAVM {
	...
	public static void main(String[] args) {
		 ...
		 *   del producto, ésta es de un sólo tipo y tamaño, se requiere determinar cuánto recibirá un productor 
		 *   por la uva que entrega en un embarque considerando lo siguiente: * Si es de tipo A, se le cargan 20
		 *    céntimos al precio inicial cuando es de tamaño 1 y 30 céntimos si es de tamaño 2. * Si es de tipo B,
