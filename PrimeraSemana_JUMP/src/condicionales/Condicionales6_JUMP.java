...
public class Condicionales6_JUMP {
	...
	public static void main(String[] args) {
		...
		//6. La asociación de vinicultores tiene como política fijar un 
		...
		//y tamaño, se requiere determinar cuánto recibirá un productor por
		//la uva que entrega en un embarque considerando lo siguiente: 
		// * Si es de tipo A, se le cargan 20 céntimos al precio inicial 
		//cuando es de tamaño 1 y 30 céntimos si es de tamaño 2. * Si es 
		//de tipo B, se rebajan 30 céntimos cuando es de tamaño 1, y 50 céntimos 
