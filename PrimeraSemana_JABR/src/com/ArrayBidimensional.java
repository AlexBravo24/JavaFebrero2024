...
public class ArrayBidimensional {
	...
	public static void main(String[] args) {
		...
		//Es una estructura que nos permite almacenar más
		...
		//El método .length en el caso de los arrays de 2 dimensiones
		...
		//que interactuen con otros métodos o si necesito
